...
if($sql){
echo "<br><br><label class='Saudacao'><center>Os boletos foram baixados com sucesso!<br>Clique <a href='baixa_boleto.php'>Aqui</a> para voltar para página de Baixa de Pagamento dos Boletos.</label><br><br>";
