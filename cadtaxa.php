...
<body leftmargin="0" topmargin="0" class="no-js">
    ...
    <tr>
        <td class="TextoTopo">Incluir Taxa</td>
    </tr>
    <tr>
        <td>
            <fieldset class="Literal">
                <legend class="Literal">Informações Gerais</legend>
                <form id="form1" action="sql_cadtaxa.php" method="post" name="form1">
                <table width="800" Class="TextoNormal" >
                <tr align="left"><td width="59">VALOR:</td>
                <td width="729">
                  <input name="valor" type="text" id="valor"  class="CampoForm2" onkeyup="numMoeda(event,this);"></td></tr>
