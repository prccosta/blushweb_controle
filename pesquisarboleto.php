...
//-->
                                        ...
                                        <td colspan="2" vAlign="top" >
                                          <table Class="TextoNormal" width="450">
                                            <tr>
                                              ...
                                              <td width="215"><input id="numdoc" name="numdoc" class="CampoTexto"></td>
                                              </tr>
                                            <tr>
                                              <td>Vencimento:</td>
                                              <td width="215"><input id="venc" name="venc" class="CampoTexto" onkeyup="FormataData(this,event)" maxlength="10"></td>
                                              </tr>
                                            <tr>
                                              <td>Cliente:</td>
                                              <td width="215"><select id="id_cadastro" name="id_cadastro" class="CampoTexto">
                                                 <option value="0">-- Selecione --</option>
                                                    <?php
                                                        $sql_cadastro = mysql_query("SELECT id, empresa FROM cadastro ORDER BY empresa");
														 while($res_cadastro = mysql_fetch_array($sql_cadastro) ) {
                                                         echo '<option value="'.$res_cadastro['id'].'">'.$res_cadastro['empresa'].'</option>';
                                                        }
                                                    ?>
                                            </select></td>
                                              </tr>
	...
	$sql2 = mysql_query("SELECT a.id_boleto, a.idcli, a.status_boleto, b.id_status, b.nome_st_boleto, c.id, c.responsavel
		...
		<td><input type='image' src='img/bt_cancelar.jpg' width='70' height='18'>
		<input id='id_boleto' type='hidden' name='id_boleto' value='".$res['id_boleto']."'>
		</form></td>
		...
		<td><input name='valor' type='text' id='valor' class='CampoForm2' readonly value='".number_format($res['valor'], 2, ',', '.')."'></td>
		<td><input name='dtpgto' type='text' id='dtpgto' class='CampoForm2' readonly value='".date_format(new DateTime($res['dtpgto']), "d/m/Y")."'></td>
		<td><input name='vlpago' type='text' id='vlpago' class='CampoForm2' readonly value='".number_format($res['vlpago'], 2, ',', '.')."'></td>
