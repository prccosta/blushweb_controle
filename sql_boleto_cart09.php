                                   ...
                                   <table width="100%" Class="TextoNormal" >					
                                     ...
                                     <tr>
                                        ...
                                        <?php
											...
											if($sql){
echo "<br><br><label class='Saudacao'><center>O cadastro do usuário foi efetuado com sucesso!<br>Clique <a href='boleto_cart09.php'>Aqui</a> para voltar para página de cadastro.</label>";
} else {
echo "<label class='Saudacao'><center>Ocorreu um erro durante o cadastro!<br>Clique <strong><a href='boleto_cart09.php'>Aqui</a></strong> para voltar para página de cadastro.</label>";
}
?>
