...
$taxa_boleto_temp = $_POST['taxa_boleto'];
$demonstrativo = $_POST['demonstrativo'];
$demonstrativo_2 = $_POST['demonstrativo_2'];

// $data_venc = date("d/m/Y", time() + ($dias_de_prazo_para_pagamento * 86400));  // Prazo de X dias OU informe data: "13/04/2006";
$data_venc = $_POST['vencimento'];

$valor_idplano = explode("|", $_POST['plano']);
$idplano = $valor_idplano[0];
$valor_cobrado = $valor_idplano[1]; // Valor - REGRA: Sem pontos na milhar e tanto faz com "." ou "," ou com 1 ou 2 ou sem casa decimal
$taxa_boleto = str_replace(",", ".",$taxa_boleto_temp);
...
$dadosboleto["demonstrativo2"] = $_POST['demonstrativo']." - ".$_POST['demonstrativo_2']."<br>Taxa bancária - R$ ".number_format($taxa_boleto, 2, ',', '');
...
$dadosboleto["instrucoes4"] = "&nbsp; Emitido por Blush! Web e Publicidade - www.blushweb.com.br";
...
$dadosboleto["cpf_cnpj"] = "082.966.677-03";
