...
$dadosboleto["demonstrativo2"] = "Mensalidade referente a Serviços de Sites e/ou Sistemas <br>Taxa bancária - R$ ".number_format($taxa_boleto, 2, ',', '');
...
// NÃO ALTERAR!
include("include/funcoes_bradescos.php"); 
include("include/layout_bradescos.php");
