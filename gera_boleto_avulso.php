...
<body leftmargin="0" topmargin="0" class="no-js">
	...
	<FORM action="boleto/boleto_bradesco_av.php" method="POST" name="consulta" id="consulta">
    ...
    <tr>
        <td class="TextoTopo">Gera&ccedil;&atilde;o de Boletos Avulso Carteira 06</td>
    </tr>
    <tr>
        <td>
            <fieldset class="Literal">
                ...
                <table width="800" Class="TextoNormal" >
                    ...
                    echo "<tr align='left'>
                      <td width='222'>VALOR:</td>
                      <td width='484'><span class='formato'>
                      <input name='plano' type='text' id='plano' size='10' maxlength='12' onkeyup='numMoeda2(event,this);' class='TextoNormal'>
                    </span></td></tr>
                    <tr align='left'>
                    ...
                    <td width='484'><span class='formato'>
                      <select name='taxa_boleto' class='TextoNormal'>
						...
						$sql3 = "SELECT * FROM taxa ORDER BY id_taxa";
                    ...
                    <td width='484'><span class='formato'>
                      <select name='demonstrativo' class='TextoNormal'>
					  <option value='0'>-- Selecione a mensagem --</option>";
                    $sql_tipo_boleto = mysql_query("SELECT * FROM tipo_boleto ORDER BY id_tipo_boleto");
					while($res_tipo_boleto=mysql_fetch_array($sql_tipo_boleto)){
						echo '<option value="'.$res_tipo_boleto['id_tipo_boleto'].'|'.$res_tipo_boleto['nome_tipo_boleto'].'">'.$res_tipo_boleto['id_tipo_boleto'].' - '.$res_tipo_boleto['nome_tipo_boleto'].'</option>';
					}
                    echo "</select> Nº parcela: <input name='demonstrativo_2' type='text' id='demonstrativo_2' size='5' maxlength='10' class='TextoNormal'></span></td></tr>
                    <tr align='left'>
                    <td width='222'>NOME DO SACADO:</td>
                    <td width='484'>".$res['empresa']."
                    <input name='idcli' type='hidden' id='idcli' value='".$res['id']."'>
                    <input name='nome' type='hidden' id='nome' value='".$res['empresa']."'></td></tr>
                    <tr align='left'>
